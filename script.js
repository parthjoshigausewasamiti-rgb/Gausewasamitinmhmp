...
const TRANSLATIONS = {
  hi: {
    ...
    hero_title_1: "गौ सेवा ही,", hero_title_2: "सच्ची सेवा है !",
...
if (upiCopyBtn && upiIdText) {
  upiCopyBtn.addEventListener('click', async () => {
    const value = upiIdText.textContent.trim();
    try {
      ...
      upiCopyBtn.classList.add('is-copied');
      upiCopyBtn.textContent = '✓';
      setTimeout(() => {
        upiCopyBtn.classList.remove('is-copied');
        upiCopyBtn.textContent = '⧉';
      }, 1800);
    } catch (err) {
